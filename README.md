...
Below are some samples from the datasets. There are 85 `panorama` or `image stitching/registration` datasets in total. You can download them in [AutoPanoStitch Compilation](https://1drv.ms/f/s!AqjW7B7BO7JJgdB7hSu2vu8OOefG4Q) 
| Type | Images |
| --- | --- |
